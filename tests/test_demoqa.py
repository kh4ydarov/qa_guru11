...
def test_registration_form():
    ...
    browser.element('#userEmail').should(be.blank).set_value('tests@gmail.com')
    ...
    browser.element('table>tbody>tr:nth-child(2)>td:nth-child(2)').should(have.text('tests@gmail.com'))
